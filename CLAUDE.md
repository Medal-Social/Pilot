...
- Coverage target: 100% while the project is small; `pnpm quality:100` runs coverage for repo guardrails plus packages (hard minimums: 97% statements/functions/lines; branches 95% CLI, 90% kit)
