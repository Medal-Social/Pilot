  ...
  <div class="page-wrap">
    ...
    <footer>
      ...
      <div class="footer-socials">
        <a href="https://linkedin.com/company/medalsocial" class="social-link" target="_blank" rel="noopener" aria-label="LinkedIn">
          ${LINKEDIN_ICON}
        </a>
        <a href="https://instagram.com/medal.tv" class="social-link" target="_blank" rel="noopener" aria-label="Instagram">
          ${INSTAGRAM_ICON}
        </a>
        <a href="https://x.com/medal_tv" class="social-link" target="_blank" rel="noopener" aria-label="X (Twitter)">
          ${X_ICON}
        </a>
      </div>
    </footer>
